...
namespace UI.Desktop
{
    public partial class Docentes : ApplicationForm
    {
        ...
        {
            PersonaDesktop ad = new PersonaDesktop(ApplicationForm.ModoForm.Alta, 1);
            ad.ShowDialog();
            this.Listar();
        }
        ...
        private void tsbNuevoUsuario_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Este docente ya cuenta con un usuario", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            catch (Exception exceptionManejada)
            {
